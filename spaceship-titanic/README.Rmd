...
In validating this model, we see that it hasn't done much better than the random forest we set up earlier. Accuracy is up slightly as well as specificity, however sensitivity is lower.
